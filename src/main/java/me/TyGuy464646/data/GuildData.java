...
public class GuildData {
	 ...
	 */
	public static void removeGuild(@NotNull Guild guild) { guilds.remove(guild.getIdLong()); }
	...
	/**
	 * Initializes the GuildSettings with an instance of KickBot if it hasn't already been initialized.
	 * @param bot instance of KickBot.
	 */
	public static void init(final KickBot bot) {
		if (!initialized) {
			initialized = true;
			GuildData.bot = bot;
		}
